...
// contains a user for every address
    ...
    // function adding_values(address memory _address,string memory _amounts,string memory _returnAmounts,string memory _tokenPair) public {
    //     var user= result[_address];
 
    //     user.addr = _address;
    //     user.amounts = _amounts;
    //     user.returnAmounts = _returnAmounts;
    //     user.tokenPair = _tokenPair;
    //     user_result.push(
    //       _address) -1;
...
//   function getAmountsB() public view returns (string[] memory){
//     //   address[]    memory addr = new address[](count);
//     //   string[]  memory name = new string[](count);
//       string[]    memory amounts = new string[](count);
//     //   string[]    memory returnAmounts = new string[](count);
...
function getReturnAmounts() public view returns (string[] memory){
    //   address[]    memory addr = new address[](count);
    //   string[]  memory name = new string[](count);
    //   string[]    memory amounts = new string[](count);
      string[]    memory returnAmounts = new string[](count);
  ...
  function getAmounts() public view returns (string[] memory){
    //   address[]    memory addr = new address[](count);
    //   string[]  memory name = new string[](count);
      string[]    memory amounts = new string[](count);
    //   string[]    memory returnAmounts = new string[](count);
